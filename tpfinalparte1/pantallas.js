function dibujarP(numP) {
     ...
     if (numP === 0) {
        ...
        text("La lámpara de Aladin", width/2, height/5);
        textSize(20);
        fill(59, 17, 99);
        stroke(255);
        strokeWeight (2);
        text("-Presiona la tecla 'ENTER' para activar sonido ", 320, 420);
        text("-Presiona la tecla 'P' para pausar y reanudar sonido", 320, 450);
