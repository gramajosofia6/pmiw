...
//video : https://youtu.be/Irpju5JWzaA?si=p29Cyil63kFqpjEm
  ...
  let fondos = {};  // para almacenar todas las imágenes de fondo en preload
 ...
 //  sacamos las variables globales para los botones de setup
    ...
    function setup() {
     ...
     // creamos  instancia  de la clase juego y le pasamos el  valor 8 que son los objetos a encontrar 
     juego = new Juego(8); 
     pantallas = new Pantallas(juego); //aca lo mmismo pero con pant y le damos acceso a los datos de juego, cuando dibuja pregunta cual es el estado act y cuanto tiempo queda
    
     //imageMode(CORNER);    //posiciona todas las img en la esquina superior izq
   }
